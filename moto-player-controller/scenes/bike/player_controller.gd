...
func _ready():
	...
	bike_gearing.max_speed = bike_physics.max_speed
	bike_steering.max_speed = bike_physics.max_speed
	bike_crash.max_speed = bike_physics.max_speed
...
func _sync_component_state():
	...
	# Gearing needs speed
	bike_gearing.speed = bike_physics.speed

	# Steering needs speed
	bike_steering.speed = bike_physics.speed

	# Tricks needs speed and bike_steering
	bike_tricks.speed = bike_physics.speed
	bike_tricks.steering_angle = bike_steering.steering_angle
	bike_tricks.max_steering_angle = bike_steering.max_steering_angle

	# Crash needs speed and bike_steering
	bike_crash.speed = bike_physics.speed
	bike_crash.max_steering_angle = bike_steering.max_steering_angle

	# Audio needs engine state
	bike_audio.speed = bike_physics.speed
	bike_audio.current_rpm = bike_gearing.current_rpm
	bike_audio.idle_rpm = bike_gearing.idle_rpm
	bike_audio.max_rpm = bike_gearing.max_rpm
	bike_audio.is_stalled = bike_gearing.is_stalled

	# UI needs display state
	bike_ui.current_gear = bike_gearing.current_gear
	bike_ui.speed = bike_physics.speed
	bike_ui.current_rpm = bike_gearing.current_rpm
	bike_ui.idle_rpm = bike_gearing.idle_rpm
	bike_ui.max_rpm = bike_gearing.max_rpm
	bike_ui.is_stalled = bike_gearing.is_stalled
	bike_ui.brake_danger_level = bike_crash.brake_danger_level
	bike_ui.fishtail_angle = bike_tricks.fishtail_angle
	bike_ui.max_fishtail_angle = bike_tricks.max_fishtail_angle
