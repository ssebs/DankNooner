...
> Notes & todo's related to marketing

## High-Level Plan

- Create **polished** MVP / Demo
  - > Finished "verticle slice" of the full game
  - Content from https://github.com/ssebs/moto-player-controller-godot/
  - Basic multiplayer w/ game modes. Can be played w/ AI single player
  - Some customization (bike, character)
  - 1 polished map
  - Traffic / Race AI to make it look polished
  - No singleplayer/story
- Create marketing plan from **Notes** below
- Create art assets (game icon, capsule art, trailer, etc.)
- Follow marketing plan (add hooks, clippable moments, etc.)
- Release **Demo** on **Itch.io**
- Gather feedback
- **???**
